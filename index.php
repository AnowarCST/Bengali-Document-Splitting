...
<head>
	...
	<title>Bangali Document Splitting</title>
</head>
<body>
<?php
...
?>
<form method="post">
	<textarea name="str" cols="80" rows="15"><?php echo $str; ?></textarea>
	<textarea name="str1" cols="80" rows="15"><?php echo $str1; ?></textarea>
	<br/>
